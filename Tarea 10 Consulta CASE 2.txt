---Utilizando la DB de empleados, diseñar una consulta que agregue una columna al inicio de la tabla empleados, indicando si el empleado es 'Supervisor', 'Administrador' u 'Operador'
